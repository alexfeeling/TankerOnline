...
:: Android packaging
set AND_CERT_NAME="TankerOnline"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TankerOnline.p12
...
set IOS_PROVISION=cert\TankerOnline.mobileprovision
...
set APP_ID=air.TankerOnline

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TankerOnline
